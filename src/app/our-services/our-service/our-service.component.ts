  ...
  services: Service[] = [
    {
      title: '3D Mockups',
      description:
        'Photorealistic visuals for packaging, e-commerce, and advertising.',
    ...
    },
    {
      ...
      description:
        'Logos, labels, and packaging that align with your brand identity.',
    ...
    },
    {
      title: 'Marketing',
      description:
        'Digital campaigns, Google Ads, SEO, and strategic brand development.',
